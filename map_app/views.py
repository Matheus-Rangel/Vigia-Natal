...
def dados_gerais(request):
	# JSON's com informação das despesas
	d1 = r"""
	[
	   {
	...
	despesas_instituicoes = json.loads(d1)
	despesa_prefeitura_por_orgaos = json.loads(d2)
	despesas_obras_e_instalacoes_por_orgaos = json.loads(d3)
	
	return render(request, 'map_app/dados_gerais.html', 
		{'despesas_instituicoes': despesas_instituicoes, 
		 'despesa_prefeitura_por_orgaos': despesa_prefeitura_por_orgaos,
		 'despesas_obras_e_instalacoes_por_orgaos': despesas_obras_e_instalacoes_por_orgaos
		})